...
pub fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::push::push_connect,
            commands::push::push_disconnect,
            commands::push::push_status,
            commands::push::push_subscribe_user,
            commands::push::push_unsubscribe_user,
            commands::push::push_user_status,
